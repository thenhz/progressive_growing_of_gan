...
desc += '-custom-arch-design';      dataset = EasyDict(tfrecord_dir='/home/thenhz/workspace/quadro/TreatiseOnArchitecturalDesign/scaled/tfrecords');      train.mirror_augment = True
